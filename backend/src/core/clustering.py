...
class ClusteringService:
    ...
    def reduce_dimensions(self, embeddings: np.ndarray,n_components: int = None) -> np.ndarray:
    ...
    def calculate_dynamic_params(self,n_samples: int,depth: int,max_depth_base: int,min_size_base: int):
    ...
    def cluster_embeddings(self, embeddings: np.ndarray,n_clusters: int = None,depth: int = 0) -> np.ndarray:
    ...
    def split_by_clusters(self,data: List,labels: np.ndarray) :
